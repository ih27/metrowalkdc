...
object LandmarkData {
    ...
    fun updateList(jsonObject: JsonObject) {
        ...
        for (i in 0 until jsonArray.size()) {
            ...
            val landmark = Landmark(id, name, imageUrl, address, lat, lon, rating, reviewCount, distance)
    ...
    fun getLandmark(jsonObject: JsonObject): Landmark {
        ...
        val address = jsonObject.get("location").asJsonObject.getAsJsonArray("display_address").get(0).asString
        ...
        return Landmark(id, name, imageUrl, address, lat, lon, rating, reviewCount)
    }
